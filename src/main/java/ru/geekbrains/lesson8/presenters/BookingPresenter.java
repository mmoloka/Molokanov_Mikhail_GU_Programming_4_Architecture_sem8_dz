...
public class BookingPresenter implements ViewObserver {
    ...
    public void updateUIShowChangeReservation(int newReservationNo) {
        view.showChangeReservation(newReservationNo);
    }
    ...
    public void onChangeReservationTable(int oldReservation, Date reservationDate, int tableNo, String name) {
        try {
            ...
            updateUIShowChangeReservation(newReservationNo);

        } catch (RuntimeException e) {
            updateUIShowChangeReservation(-1);
        }
    }
